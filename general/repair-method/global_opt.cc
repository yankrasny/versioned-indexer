...
private:
	...
	TradeoffHeap heap;
public:
	TradeoffOptimizer(unsigned numDocs, unsigned fragAppBudget) : numDocs(numDocs), fragAppBudget(fragAppBudget) {
		totalNumFragApps = 0;
...
int main(int argc, char** argv)
{
	...
	TradeoffOptimizer optimizer = TradeoffOptimizer(numDocs, fragAppBudget);
	optimizer.fillHeap();
